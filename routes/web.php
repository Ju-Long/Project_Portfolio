...
Route::get('/gym_planner/add_exercise_data', [DatabaseController::class, 'add_exercise_data']);
Route::get('/gym_planner/edit_exercise_data', [DatabaseController::class, 'edit_exercise_data']);
